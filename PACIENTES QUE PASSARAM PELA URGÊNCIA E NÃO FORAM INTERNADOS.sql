--PACIENTES QUE PASSARAM PELA URGÊNCIA E NÃO FORAM INTERNADOS
...
WHERE atendime.cd_paciente=paciente.cd_paciente(+) and
      ...
      and not exists (select '1' from dbamv.atendime b
                              ...
                              and trunc(b.dt_atendimento) >= '01/06/2014'
                              and trunc(b.dt_atendimento) <= '30/06/2014'

                                 )
      and trunc(atendime.dt_atendimento) >= '01/06/2014'
      and trunc(atendime.dt_atendimento) <= '30/06/2014'
