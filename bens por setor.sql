...
--AND   B.SN_GARANTIA_PENHORA =  NVL(?, 'N')
...
ORDER BY EMPRESA,CD_EMPRESA,DS_EMPRESA,
CODIGO_SETOR,DESCRICAO_SETOR,
CODIGO_LOCALIDADE,DESCRICAO_LOCALIDADE